...
class DownloadScriptGenerator:
    ...
    def _build_script_header(self, run_id: str) -> List[str]:
        ...
        return [
            ...
            "",
            f'MODELS_DIR="{config.models_dir or ""}"',
            'STATE_SCRIPT="python3 -c "from src.comfyfixersmart.state_manager import StateManager; sm = StateManager(); " 2>/dev/null || true',
            "",
        ]
...
class DownloadManager:
    ...
    def _get_target_path(self, result: Dict[str, Any]) -> str:
        ...
        model_type = result.get('type', 'checkpoints')
        filename = result['filename']
        return str(self.output_dir / model_type / filename)
    ...
    def generate_download_script(self, search_results: List[Dict[str, Any]],
        ...
        return self.script_generator.generate_script(tasks, script_path, run_id)
