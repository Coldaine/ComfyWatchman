...
class TestCivitaiAdvancedSearch:
    ...
    def test_query_search_baseline(self, monkeypatch):
        ...
        with patch('requests.get') as mock_get:
            ...
            model_info = {
                'filename': 'hand_fine_tuning_sdxl.safetensors',
                'type': 'loras'
            }
...
class TestMultiStrategySearch:
    ...
    def test_extract_tags_from_query(self):
        ...
        expected_tags = ['pussy', 'anus', 'breasts', 'ass', 'thighs', 'realistic', 
                        'high', 'definition', 'hd', 'detailed', 'detail', 'nsfw', 
                        'explicit', 'nude', 'naked', 'adult', 'better', 'detailed', 
                        'pussy', 'anus', 'v3', 'v3.0']
